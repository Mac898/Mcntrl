...
class EXTHDSL444():
    ...
    def mask(self, a_screen):
        """Mask an output (number 1-4)"""
        self.t.write("#mask "+a_screen)

    def unmask(self, a_screen):
        """Unmask an output (number 1-4)"""
        self.t.write("#unmask "+a_screen)
